                                                ...
                                                <div className="block-inn">
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xs={4}>
                                                            <Form.Group className="form-group">
                                                                <span
                                                                    className="input-title">Soyadı, adı, ata adı *</span>
                                                                <Form.Label>
                                                        ...
                                                        <div className="block-inn">
                                                            <Row>
                                                                <Col xs={12}>
                                                                    <Form.Group className="form-group">
                                                                        <span
                                                                            className="input-title">Hərbi Status</span>
                                                                        <Select
                                                            ...
                                                            <Row>
                                                                <Col xs={4}>
                                                                    <Form.Group className="form-group">
                                                                        ...
                                                                        <Form.Label>
                                                                            <Form.Control
                                                                                placeholder="Seriyanı daxil edin"
                                                                ...
                                                                <Col xs={6}>
                                                                    <Form.Group className="form-group">
                                                                        <span
                                                                            className="input-title">Bitmə tarixi</span>
                                                                        <Form.Label className="relative m-0">
                                                                            <DatePicker
                                                ...
                                                <div className="block-inn">
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xs={4}>
                                                            <Form.Group className="form-group">
                                                                <span
                                                                    className="input-title">İş nömrəsi ( daxili)</span>
                                                                <Form.Label>
                                                                    <Form.Control
                                                                        type="number"
                                                                        placeholder="994XXXXXXXXX"
                                                        ...
                                                        <Col xs={4}>
                                                            <Form.Group className="form-group">
                                                                <span
                                                                    className="input-title">E-mail ünvanı (şəxsi)</span>
                                                                <Form.Label>
                                                                    <Form.Control
                                                            ...
                                                            <div className="block-inn">
                                                                <Row>
                                                                    ...
                                                                    <Col xs={4}>
                                                                        <Form.Group className="form-group">
                                                                            <span
                                                                                className="input-title">Verən orqan</span>
                                                                            <Form.Label>
                                                                                <Form.Control
                                                                                    placeholder="Verən orqan daxil et"
                                                                            ...
                                                                            <div key={uid(item, index)}
                                                                                ...
                                                                                <div>
                                                                                    <div className="radio-content">
                                                                                        <h5>Əsas iş yeridir yoxsa əlavə
                                                                                            iş
                                                                                            yeri?</h5>
                                                                                        <div className="flex-start">
                                                                                            <div
                                                                                    ...
                                                                                    <Row>
                                                                                        <Col xs={6}>
                                                                                            <Form.Group
                                                                                                ...
                                                                                                <span
                                                                                                    className="input-title">İşçinin işlədiyi şirkət</span>
                                                                                                <Form.Label>
                                                                                                    <Form.Control
                                                                                ...
                                                                                className="input-title">Struktur bölmə</span>
                                                                                        ...
                                                                                        <Col xs={4}>
                                                                                            <Form.Group
                                                                                                className="form-group">
                                                                                                <span
                                                                                                    className="input-title">İşçinin işlədiyi vəzifə</span>
                                                                                                <Form.Label>
                                                                                                    <Form.Control
                                                                                                        placeholder="Struktur bölmə daxil et"
                                                                                                        value={item.position || ''}
                                                                                        ...
                                                                                        <Col xs={4}>
                                                                                            <Form.Group
                                                                                                className="form-group">
                                                                                                <span
                                                                                                    className="input-title">İşə qəbul tarixi</span>
                                                                                                <Form.Label
                                                                                                    className="relative m-0">
                                                                                                    <DatePicker
                                                                                        ...
                                                                                        <Col xs={6}>
                                                                                            <Form.Group
                                                                                                className="form-group">
                                                                                                <span
                                                                                                    className="input-title">İşdən azad tarixi</span>
                                                                                                <Form.Label
                                                                                                    className="relative m-0">
                                                                                                    <DatePicker
                                                                                                        value={item.endDate || ''}
                                                                                        ...
                                                                                        <Col xs={6}>
                                                                                            <Form.Group
                                                                                                className="form-group">
                                                                                                <span
                                                                                                    className="input-title">İşdən azad olma maddəsi</span>
                                                                                                <Form.Label>
                                                                                                    <Form.Control
                                                                                        ...
                                                                                        <Col xs={6}>
                                                                                            <Form.Group
                                                                                                className="form-group">
                                                                                                <span
                                                                                                    className="input-title">İş statusu</span>
                                                                                                <Select
                                                                ...
                                                                <div key={uid(item, index)}
                                                                    ...
                                                                    <Row>
                                                                        ...
                                                                        <Col xs={4}>
                                                                            <Form.Group className="form-group">
                                                                                <span
                                                                                    className="input-title">İş yeri</span>
                                                                                <Form.Label>
                                                                                    <Form.Control
                                                                        ...
                                                                        <Col xs={4}>
                                                                            <Form.Group className="form-group">
                                                                                <span
                                                                                    className="input-title">Yaşayış</span>
                                                                                <Form.Label>
                                                                                    <Form.Control
